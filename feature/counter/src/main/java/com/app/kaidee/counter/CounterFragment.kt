...
import com.app.kaidee.counter.navigation.CounterNavigatorImpl
...
class CounterFragment : Fragment(), MviView<CounterIntent, CounterViewState> {
	...
	private val counterNavigator by lazy {
		CounterNavigatorImpl().apply {
	...
	private fun setupView() {
		...
		button_lesson?.setOnClickListener {
			counterNavigator.navigateToLessonPage()
		}
	}
